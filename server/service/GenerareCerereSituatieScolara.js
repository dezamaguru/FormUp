...
const generareSituatieScolara = async (req, res) => {
    try {
        ...
        const templatePath = path.resolve(__dirname, '../templates/solicitare_situatie_scolara.docx');
        ...
        res.setHeader('Content-Disposition', 'attachment; filename=cerere_situatie_scolara.docx');
        res.send(buffer);
...
module.exports = { generareSituatieScolara };