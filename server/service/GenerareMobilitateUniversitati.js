...
const generareMobilitateUniversitati = async (req, res) => {
    try {
        ...
        const templatePath = path.resolve(__dirname, '../templates/mobilitati_universitati.docx');
...
module.exports = { generareMobilitateUniversitati };
