...
const generareCerereBursaSociala = async (req, res) => {
    try {
        ...
        const templatePath = path.resolve(__dirname, '../templates/bursa_sociala.docx');
        ...
        res.setHeader('Content-Disposition', 'attachment; filename=cerere_bursa_sociala.docx');
        res.send(buffer);
...
module.exports = { generareCerereBursaSociala };