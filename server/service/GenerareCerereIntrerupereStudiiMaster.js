...
const generareCerereIntrerupereMaster = async (req, res) => {
    try {
        ...
        const templatePath = path.resolve(__dirname, '../templates/cerere_intrerupere_studii_master.docx.docx');
...
module.exports = { generareCerereIntrerupereMaster};