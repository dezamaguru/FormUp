...
const generareCerereMarire = async (req, res) => {
    try {
        ...
        const templatePath = path.resolve(__dirname, '../templates/cerere_marire_nota.docx');
        ...
        res.setHeader('Content-Disposition', 'attachment; filename=cerere_marire_nota.docx');
        res.send(buffer);
...
module.exports = { generareCerereMarire };